...
export default function GithubRepoCard({ repo, theme }) {
  ...
  return (
    <div className="repo-card-div" style={{ backgroundColor: theme.text }}>
      <Fade bottom duration={2000} distance="40px">
        <div key={repo.id} onClick={() => openRepoinNewTab(repo.url)}>
          <div className="repo-name-div">
            ...
            <p className="repo-name" style={{ color: theme.body }}>
              {repo.name}
            </p>
          </div>
          <p className="repo-description" style={{ color: theme.body }}>
            {repo.description}
          </p>
